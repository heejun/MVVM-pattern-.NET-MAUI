...
public class RecipeListItemViewModelTests
{
    ...
    {
        //Arrange, Act
        //var sut = new RecipeListItemViewModel("id", "title", true, "image");
    ...
    public void FavoriteUpdateMsgReceived_SameId_FavoriteUpdated(bool originalValue, bool updateToValue)
    {
        //Arrange
